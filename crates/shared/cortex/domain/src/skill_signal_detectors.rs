...
//! word/phrase-boundary matching style used by Cortex incident analysis. The
//! detectors are domain policy shared by persistence grouping and evidence
//! classification, with no database or transport dependency.
