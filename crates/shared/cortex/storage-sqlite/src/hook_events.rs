...
//! migration 40 (`src/db/pool.rs`). Extraction happens in
//! `crate::inputs` (Claude runtime attachments) and
...
use crate::inputs::ExtractedHookEvent;
pub use cortex_domain::HookEventEntry as AiHookEventEntry;
