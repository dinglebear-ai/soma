...
pub use cortex_domain::{
    GraphEntity as GraphEntityRow, GraphEntityCandidate as GraphEntityCandidateRow,
};
...
pub const ENTITY_TYPE_LOGICAL_SERVICE: &str =
    crate::entity_resolution::vocab::ENTITY_TYPE_LOGICAL_SERVICE;
/// Host-scoped runtime deployment of a logical service (`nashost/plex`).
pub const ENTITY_TYPE_SERVICE_INSTANCE: &str =
    crate::entity_resolution::vocab::ENTITY_TYPE_SERVICE_INSTANCE;
...
pub const REL_INSTANCE_OF: &str = crate::entity_resolution::vocab::REL_INSTANCE_OF;
...
/// effective confidence is capped by `cortex_domain::graph_confidence::TRUST_CORRELATED_CEILING`.
...
pub const REASON_RESOLVER_INSTANCE_OF: &str =
    crate::entity_resolution::vocab::REASON_RESOLVER_INSTANCE_OF;
...
pub const REASON_RESOLVER_SERVICE_INSTANCE: &str =
    crate::entity_resolution::vocab::REASON_RESOLVER_SERVICE_INSTANCE;
...
pub const REASON_RESOLVER_RAW_APP_LABEL: &str =
    crate::entity_resolution::vocab::REASON_RESOLVER_RAW_APP_LABEL;
...
///
/// Unlike the private `graph_walk_service_topic` projection helper,
...
pub fn refresh_graph_projection_incremental(pool: &DbPool) -> Result<GraphRebuildOutcome> {
    ...
    // instead of merging deltas on top of a mixed-contract graph.
    {
        ...
        if legacy_rows {
            tracing::warn!(
                contract = crate::entity_resolution::vocab::GRAPH_PROJECTION_CONTRACT_V2,
...
fn extract_log_row(
    ...
    let projectable_app = row
        ...
        .filter(|app| {
            !matches!(
                crate::entity_resolution::classify_legacy_shape(app),
                Some(crate::entity_resolution::LegacyShape::SlashTriplet)
            )
        });
