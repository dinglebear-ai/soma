...
//! `cortex_domain::skill_signal_detectors`, and scores/sorts the resulting
...
use cortex_domain::skill_signal_detectors::{
...
pub use cortex_domain::{SkillIncident, SkillSignalCounts};
