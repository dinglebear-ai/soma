...
use crate::inputs::{ExtractedSkillEvent, SkillEventKind, SkillEvidenceKind};
use crate::pool::init_pool;

fn test_pool() -> (crate::DbPool, tempfile::TempDir) {
...
fn insert_log_row(pool: &crate::DbPool, hostname: &str, timestamp: &str) -> i64 {
