...
pub use cortex_domain::AbuseMatch as AiAbuseMatch;
pub use cortex_domain::{AbuseIncident, AppLogCount, LogEntry, SeverityCount};
...
pub struct IncidentContextParams {
    ...
    pub host: Option<String>,
    pub app: Option<String>,
    /// Optional FTS5 query applied to returned error logs.
    pub query: Option<String>,
    pub severity_min: Option<String>,
