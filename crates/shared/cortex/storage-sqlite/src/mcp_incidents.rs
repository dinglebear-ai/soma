...
//! signals in `cortex_domain::mcp_signal_detectors`, and scores/sorts the
...
use cortex_domain::mcp_signal_detectors::{
...
pub use cortex_domain::{McpIncident, McpSignalCounts};
