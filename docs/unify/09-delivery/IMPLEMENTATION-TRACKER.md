...
| product-family | 6 | `feat/operations-surface-contracts` | `feat/operations-schema-diagnostics` | `~/workspace/soma/.worktrees/operations-surface-contracts` | O2 closed parameter schemas and diagnostic surface projections | pending | parity_verifying |
