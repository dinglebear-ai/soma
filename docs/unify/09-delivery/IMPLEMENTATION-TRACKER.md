...
| product-family | 12 | `feat/infra-read-expansion` | `feat/infra-foundation` | `~/workspace/soma/.worktrees/infra-read-expansion` | Docker telemetry, Compose logs, process, OS logs, and ZFS reads | pending | parity_verifying |
