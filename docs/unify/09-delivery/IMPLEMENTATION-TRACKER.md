...
| product-family | 10 | `feat/fleet-foundation` | `feat/synapse-compat-adapters` | `~/workspace/soma/.worktrees/fleet-foundation` | Neutral topology, pooling, OpenSSH, forwarding, transfer lifecycle, and bounded fanout | pending | parity_verifying |
