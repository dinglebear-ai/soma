...
| product-family | 19 | `feat/mutation-final` | `feat/mutation-exec` | `~/workspace/soma/.worktrees/mutation-final` | Verified Docker cleanup, Compose teardown, and digest-bound file transfer; completes 59/59 canonical operations | pending | parity_verifying |
