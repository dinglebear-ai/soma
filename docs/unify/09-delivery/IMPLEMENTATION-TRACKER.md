...
| product-family | 14 | `feat/mutation-foundation` | `feat/synapse-canonical-cutover` | `~/workspace/soma/.worktrees/mutation-foundation` | Plan-bound verified container and Compose mutation foundation | pending | parity_verifying |
