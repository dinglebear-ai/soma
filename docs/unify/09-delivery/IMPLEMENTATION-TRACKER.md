...
| product-family | 17 | `feat/mutation-recreate` | `feat/mutation-builds` | `~/workspace/soma/.worktrees/mutation-recreate` | Configuration-bound verified container and Compose replacements | pending | parity_verifying |
