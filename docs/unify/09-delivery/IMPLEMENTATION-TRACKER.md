...
| product-family | 18 | `feat/mutation-exec` | `feat/mutation-recreate` | `~/workspace/soma/.worktrees/mutation-exec` | Bounded container, host, and stable partial fanout execution mutations | pending | parity_verifying |
