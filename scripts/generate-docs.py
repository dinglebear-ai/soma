...
def env_purpose(spec: EnvSpec) -> str:
    purposes = {
        ...
        "SOMA_PYTHON_ENVIRONMENT_CACHE_ROOT": "Absolute root for content-addressed Python environment caches.",
        "SOMA_PYTHON_ENVIRONMENT_UV_PROGRAM": "Absolute path to the exact `uv` executable used to lock and synchronize environments.",
        "SOMA_PYTHON_ENVIRONMENT_UV_VERSION": "Version identity of the configured `uv` executable; included in cache keys.",
        "SOMA_PYTHON_ENVIRONMENT_PYTHON_EXECUTABLE": "Absolute path to the Python interpreter used to create environments.",
        "SOMA_PYTHON_ENVIRONMENT_RUNTIME_IMPLEMENTATION": "Configured interpreter implementation identity, such as `cpython`.",
        "SOMA_PYTHON_ENVIRONMENT_RUNTIME_VERSION": "Configured interpreter version identity, such as `3.12.4`.",
        "SOMA_PYTHON_ENVIRONMENT_RUNTIME_PLATFORM": "Configured interpreter platform identity, such as `linux-x86_64`.",
        "SOMA_PYTHON_ENVIRONMENT_WHEEL_PLATFORM_TAG": "Wheel platform tag required for the configured interpreter, such as `manylinux_2_17_x86_64`.",
        "SOMA_PYTHON_ENVIRONMENT_SDK_WHEEL": "Absolute path to the exact Soma SDK/native wheel installed into each environment.",
        "SOMA_PYTHON_ENVIRONMENT_SDK_WHEEL_SHA256": "Expected 64-hex SHA-256 digest of the configured SDK/native wheel.",
        "SOMA_PYTHON_ENVIRONMENT_OFFLINE": "Require an already-complete cache and forbid `uv` execution on a cache miss.",
        "SOMA_PYTHON_ENVIRONMENT_UPDATE": "Resolve a new immutable candidate generation during provider preparation.",
        "SOMA_PYTHON_ENVIRONMENT_POLICY_VERSION": "Require the configured environment policy schema to match this Soma binary.",
...
def env_default(spec: EnvSpec, host: str, port: int) -> str:
    defaults = {
        ...
        "SOMA_PYTHON_ENVIRONMENT_OFFLINE": "`false`",
        "SOMA_PYTHON_ENVIRONMENT_UPDATE": "`false`",
        "SOMA_PYTHON_ENVIRONMENT_POLICY_VERSION": "`2`",
    }
...
def placeholder_for(spec: EnvSpec) -> str:
    placeholders = {
        ...
        "SOMA_PYTHON_ENVIRONMENT_ENABLED": "false",
        "SOMA_PYTHON_ENVIRONMENT_CACHE_ROOT": "/var/cache/soma",
        "SOMA_PYTHON_ENVIRONMENT_UV_PROGRAM": "/usr/local/bin/uv",
        "SOMA_PYTHON_ENVIRONMENT_UV_VERSION": "0.11.31",
        "SOMA_PYTHON_ENVIRONMENT_PYTHON_EXECUTABLE": "/usr/bin/python3.12",
        "SOMA_PYTHON_ENVIRONMENT_RUNTIME_IMPLEMENTATION": "cpython",
        "SOMA_PYTHON_ENVIRONMENT_RUNTIME_VERSION": "3.12.4",
        "SOMA_PYTHON_ENVIRONMENT_RUNTIME_PLATFORM": "linux-x86_64",
        "SOMA_PYTHON_ENVIRONMENT_WHEEL_PLATFORM_TAG": "manylinux_2_17_x86_64",
        "SOMA_PYTHON_ENVIRONMENT_SDK_WHEEL": "/opt/soma/soma_provider.whl",
        "SOMA_PYTHON_ENVIRONMENT_SDK_WHEEL_SHA256": "<64 hexadecimal characters>",
        "SOMA_PYTHON_ENVIRONMENT_OFFLINE": "false",
        "SOMA_PYTHON_ENVIRONMENT_UPDATE": "false",
        "SOMA_PYTHON_ENVIRONMENT_POLICY_VERSION": "2",
        "SOMA_MCP_TOKEN": "",
